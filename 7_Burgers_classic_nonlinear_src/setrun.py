...
#------------------------------
    ...
    probdata.add_param('mu',AddSetRun.mu,  'viscosity')
    probdata.add_param('xlim', AddSetRun.xlim,  'box end')
    probdata.add_param('a', AddSetRun.a,  'a coef')
    probdata.add_param('method', AddSetRun.method,  'method for solving the source term')
    ...
    clawdata.upper[0] = AddSetRun.xmax         # xupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = AddSetRun.mx     # mx
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = AddSetRun.nbsim
